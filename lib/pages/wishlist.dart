...
class WishlistProduct extends StatelessWidget {
  ...
  WishlistProduct({this.prodName, this.prodPrice, this.prodSeller, this.prodPicture, this.oldPrice, this.prodDetails});
                  ...
                  Navigator.of(context).push(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        height: 10.0,
                        child: Text(prodName, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13.0),)
                      ),
